...
//go:generate mockgen -destination mock_cache.go -package cache github.com/apus-run/van/cache/store KeyGetter
...
func keyFunc(key any) string {
	...
	default:
		...
		_, _ = fmt.Fprint(digester, reflect.TypeOf(typed))
		_, _ = fmt.Fprint(digester, typed)
